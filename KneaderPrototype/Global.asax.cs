    ...
    public class MvcApplication : System.Web.HttpApplication
    {
        ...
        protected void Session_OnEnd()
        {
            if (HttpContext.Current != null)
            {
                ...
                {
                    HttpContext.Current.Response.Redirect("~/Account/Login/");
                    KneaderPrototype.Error.toFile("Session_onEnd hapened", this.GetType().Name.ToString());
                }
            }
            else {
                KneaderPrototype.Error.toFile("Session_onEnd hapened with null current context", this.GetType().Name.ToString());
            }
        }
